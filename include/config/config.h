...
#define STEPPER_DRIVER_DRV8833   2

// Select stepper driver here.
// DRV8833 uses AN1/AN2/BN1/BN2/STBY mapping from wiring profile.
#ifndef STEPPER_DRIVER_TYPE
#define STEPPER_DRIVER_TYPE      STEPPER_DRIVER_DRV8833
#endif

#if (STEPPER_DRIVER_TYPE != STEPPER_DRIVER_A4988) && \
	(STEPPER_DRIVER_TYPE != STEPPER_DRIVER_DRV8825) && \
	(STEPPER_DRIVER_TYPE != STEPPER_DRIVER_DRV8833)
#error "Invalid STEPPER_DRIVER_TYPE. Use A4988, DRV8825, or DRV8833."
#endif

// Load pin mapping for the selected stepper driver wiring profile.
#include "wiring.h"
